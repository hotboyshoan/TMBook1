 ...
 * @author Admin
 */
@WebServlet(name = "XuLyXoaCTHDAdmin", urlPatterns = {"/XuLyXoaCTHDAdmin"})
public class XuLyXoaCTHDAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int ketqua = tbChitietHoadon.DeleteCTHDAdmin(id);
            if(ketqua<=0)
