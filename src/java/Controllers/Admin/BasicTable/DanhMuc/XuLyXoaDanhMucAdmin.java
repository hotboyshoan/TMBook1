 ...
 * @author Admin
 */
@WebServlet(name = "XuLyXoaDanhMucAdmin", urlPatterns = {"/XuLyXoaDanhMucAdmin"})
public class XuLyXoaDanhMucAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int ketqua = tbCategory.DeleteListAdmin(id);
            if(ketqua<=0)
