 ...
 * @author Admin
 */
@WebServlet(name = "XuLyXoaSanPhamAdmin", urlPatterns = {"/XuLyXoaSanPhamAdmin"})
public class XuLyXoaSanPhamAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int ketqua = tbSanpham.DeleteBillAdmin(id);
            if(ketqua<=0)
