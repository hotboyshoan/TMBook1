<%-- 
    Document   : basket
    Created on : Jul 13, 2020, 8:46:42 AM
    Author     : Admin
--%>
                ...
                <form method="post" action="checkout1.jsp">
                  ...
                  <p class="text-muted">You currently have 
                      <%                         
                          ...
                          numberCart = MyClass.NullCart(cart);
                          if(numberCart==-2){
                              out.println("Loi ex");
                          }
                      %>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                          ...
                          if(cart == null){
                              out.println("<h3> Chưa có giỏ hàng");
                          }else{
                              int tongtien = 0;
                        ...
                        <tr>
                          ...
                          <td><a href="#"><%=sp.getTensp()%></a></td>
                          <td>
                            <input type="number" value="<%=soluong%>" class="form-control">
                          </td>
                          <td><%=String.format("%,d",sp.getGiasp())%></td>
                          <td>$0.00</td>
                          <td><%=String.format("%,d",thanhtien)%></td>
                          <td><a href="cart_del?id=<%=id%>"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                                <%
                                }
                            }
...
<!--                        <tr>
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th colspan="2"><%=String.format("%,d",tongtien)%></th>
                        </tr>
                      </tfoot>
                      <%
                          }
                  ...
                  <div class="box-footer d-flex justify-content-between flex-column flex-lg-row">
                    <div class="left"><a href="index.jsp?module=p_cate&catid=1" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i> Continue shopping</a></div>
                    <div class="right">
