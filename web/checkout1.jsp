<%-- 
    Document   : checkout
    Created on : Jul 13, 2020, 6:23:04 PM
    Author     : Admin
--%>
                ...
                <form method="post" action="cart_checkout" >
                  ...
                  <div class="content py-3">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="firstname" name="tHoten" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="company">Ngày nhận</label>
                          <input id="company" name="tNgaynhan" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="street">Điện thoại</label>
                          <input id="street" name="tDienthoai" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <!-- /.row-->
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="phone" name="phoneNumber" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
